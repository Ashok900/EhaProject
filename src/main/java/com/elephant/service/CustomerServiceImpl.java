...
//			 
			 ...
			 Mail mail = new Mail();
		        ...
		        model.put("signature",Constants.POST_URL+"/v1/confirm?email="+customer.getEmail()+"&validate="+customer.getValitateCode());
		        mail.setModel(model);
